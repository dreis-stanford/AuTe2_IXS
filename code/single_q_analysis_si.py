...
Matches MATLAB calcIXS_single_Q_Silicon.m and interactive script
"""
...
class SingleQAnalyzer:
    ...
    Matches MATLAB calcIXS_single_Q_Silicon.m
    """
    ...
    def analyze(self, Q_input, coords='primitive', freq_unit='meV', print_results=True, 
        ...
        Q_conv_G = fcc_prim2conv_k(Q_prim_rounded)
        Q_conv_reduced = fcc_prim2conv_k(Q_prim_reduced)
    ...
    def _print_results(self, result, detailed=False, freq_unit='meV'):
        ...
        print('\n' + '╔' + '='*64 + '╗')
        print('║  IXS Analysis at Single Q Point - Silicon' + ' '*24 + '║')
        print('╚' + '='*64 + '╝\n')
        ...
        print(f'  f(Q) Si:  {result["form_factors"]["Si"]:.2f} (Z=14)')
        ...
        print(f'Mode  Freq({freq_label:>4s})   L-char   IXS(S)    IXS(AS)   Si1%  Si1‖   Si2%  Si2‖   Pol')
        print('─'*95)
...
def interactive_mode():
    ...
    print("=" * 70)
    print("  Interactive IXS Analysis for Silicon")
    print("=" * 70)
